...
``` {r prediction}
# I use a bunch of machine learning advanced classification algorithms to assess which of them provide the lowest out of error sample for this project
...
# I could not install rattle because an R version problem for a package that rattle depends on (GTK and RtGK2)
